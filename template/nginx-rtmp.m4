...
RUN wget -qO - ${NGINX_RTMP_REPO} | tar xz && mv nginx-rtmp-module-${NGINX_RTMP_VER#v} nginx-rtmp-module && \
    cd nginx-rtmp-module && \
    mkdir -p /home/build/var/www/html && \
    cp -f stat.xsl /home/build/var/www/html && \
    wget -qO - ${NGINX_RTMP_PATCH_HLS} | patch -p1 && \
    wget -qO - ${NGINX_RTMP_PATCH_DASH} | patch -p1;
